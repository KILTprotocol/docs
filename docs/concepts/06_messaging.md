...
For a detailed developer-oriented guide about how to protect against *replay attacks*, see our [Replay Protection Cookbook section](../develop/01_sdk/02_cookbook/05_messaging/02_replay_protection.md).
:::
