...
If you want to learn more about CTypes take a look at our [in depth CType documentation](/docs/develop/sdk/core-feature/ctypes). You can also [read through existing ctypes in our ctype-index](https://github.com/KILTprotocol/ctype-index).
:::
