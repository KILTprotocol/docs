...
Before the <span className="label-role claimer">Claimer</span> can receive an attestation, they need to generate a [light DID](../1-sdk/02-Cookbook/01-How%20to%20manage%20KILT%20DIDs/0_did.md#light-dids), which they can do completely off-chain.
