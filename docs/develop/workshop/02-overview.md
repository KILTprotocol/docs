...
Before the <span className="label-role claimer">Claimer</span> can receive an attestation, they need to generate a [light DID](../1-sdk/9-core-feature/0_did.md#light-dids), which they can do completely off-chain.
