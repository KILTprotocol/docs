...
Otherwise, in case of 2ii. and 2iii., you need to manually initiate the unlocking period if you don't want to or cannot delegate to another Collator candidate.
</TabItem>
</Tabs>
