...
If you want to learn more about CTypes take a look at our [in depth CType documentation](./../../../develop/01_sdk/02_Cookbook/04_Issue%20and%20verify%20a%20KILT%20credential/01_ctypes.md). You can also [read through existing ctypes in our ctype-index](https://github.com/KILTprotocol/ctype-index).
:::
