...
Before the <span className="label-role claimer">Claimer</span> can attest a credential, they need to generate a [DID](../01_sdk/02_cookbook/01_dids/01_full_did_creation.md).
