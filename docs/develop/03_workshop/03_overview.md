...
Before the <span className="label-role claimer">Claimer</span> can receive an attestation, they need to generate a light DID, which they can do completely off-chain.
