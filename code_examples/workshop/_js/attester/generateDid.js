...
export function createFullDid() {
  return __awaiter(this, void 0, void 0, function* () {
    yield Kilt.init({ address: process.env.WSS_ADDRESS })
    const { api } = yield Kilt.connect()
    ...
    return new Kilt.Did.FullDidCreationBuilder(api, keys.authentication)
      ...
      .buildAndSubmit(keystore, account.address, (creationTx) =>
        __awaiter(this, void 0, void 0, function* () {
          yield Kilt.BlockchainUtils.signAndSubmitTx(creationTx, account, {
...
export function getFullDid(didUri) {
  return __awaiter(this, void 0, void 0, function* () {
    // make sure the did is already on chain
    const onChain = yield Kilt.Did.FullDidDetails.fromChainInfo(didUri)
